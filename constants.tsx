...
export const KO_DATA = {
  ...
  home: {
    ...
    strengthsTitle: "아이캔 우주교육의 코어가치",
    specialProjectsTitle: "새로운 생태계에서 모두가 슈퍼키즈",
    specialProjects: [
      {
        title: "Space Aporia",
  ...
  fees: {
    ...
    visaItems: [
      { item: "SSP + 카드 비용", cost: "10,000 페소", note: "외국인 학업 허가증 (필수)" },
      { item: "관광비자 연장 (1차)", cost: "약 2,070 페소", note: "29일 이상 체류 시" },
      { item: "관광비자 연장 (2차)", cost: "약 5,500 페소", note: "59일 이상 체류 시 (ACR I-Card 포함)" },
