...
const BustlingCrowd: React.FC = () => {
    ...
    const people = [
        ...
        // --- 20 Adult Women (Full Body) ---
        { e: '🚶‍♀️', t: '6%', l: '40%', s: 0.9, d: 1.3 },
        { e: '💃', t: '10%', l: '58%', s: 0.95, d: 2.1 },
        { e: '🏃‍♀️', t: '14%', l: '42%', s: 0.85, d: 0.4 },
        { e: '🧍‍♀️', t: '18%', l: '50%', s: 1.0, d: 3.2 },
        { e: '🚶‍♀️', t: '22%', l: '65%', s: 0.9, d: 1.7 },
        { e: '🏃‍♀️', t: '26%', l: '35%', s: 0.8, d: 0.9 },
        { e: '💃', t: '30%', l: '52%', s: 1.05, d: 2.8 },
        { e: '🧍‍♀️', t: '34%', l: '40%', s: 0.95, d: 1.1 },
        { e: '🏃‍♀️', t: '38%', l: '60%', s: 0.85, d: 0.5 },
        { e: '🤸‍♀️', t: '42%', l: '47%', s: 0.8, d: 2.4 },
        { e: '🚶‍♀️', t: '46%', l: '55%', s: 0.95, d: 3.6 },
        { e: '💃', t: '50%', l: '38%', s: 1.05, d: 1.5 },
        { e: '🏃‍♀️', t: '54%', l: '65%', s: 0.9, d: 0.3 },
        { e: '🧍‍♀️', t: '58%', l: '45%', s: 1.0, d: 2.9 },
        { e: '🚶‍♀️', t: '62%', l: '50%', s: 0.95, d: 1.8 },
        { e: '🧘‍♀️', t: '66%', l: '55%', s: 0.85, d: 0.7 },
        { e: '🏃‍♀️', t: '70%', l: '40%', s: 0.8, d: 3.3 },
        { e: '💃', t: '74%', l: '62%', s: 1.1, d: 2.2 },
        { e: '🧍‍♀️', t: '78%', l: '48%', s: 0.95, d: 1.4 },
        { e: '🚶‍♀️', t: '82%', l: '52%', s: 1.0, d: 0.6 },
