...
const JOURNAL_ENTRIES = [
    {
        id: 20,
        date: "2026.03.24 • Tue",
        title: "[Episode] AI 에이전트 시대: 스스로 행동하는 아이로 키우는 법",
        subtitle: "명령을 기다리는 기계에서 스스로 판단하는 동반자로: 에이전틱 AI가 바꾸는 교육의 본질",
        themeChip: "Agentic Future",
        morning: {
            title: "AI가 스스로 움직이기 시작했습니다",
            content: "어머님, 최근 AI 업계에서 가장 뜨거운 화두는 '에이전틱 AI(Agentic AI)'입니다. 기존의 AI가 질문에 답하는 수동적 도구였다면, 에이전틱 AI는 스스로 목표를 설정하고, 계획을 세우고, 도구를 활용하여 문제를 해결하는 '자율적 행동자'입니다. 구글, 앤트로픽, 오픈AI 모두 이 방향으로 전력 질주하고 있습니다. 이 거대한 전환은 우리 아이들의 교육에도 근본적인 질문을 던집니다. AI조차 '스스로 생각하고 행동하는 능력'을 갖추는 시대에, 여전히 정답만 외우게 할 것인가? 아이캔이 지향하는 우주적 사고(Cosmic Thinking)의 핵심은 바로 여기에 있습니다.",
            icon: Cpu,
            color: "orange",
            mission: "Mission: 오늘 아이에게 '만약 네가 AI 에이전트를 하나 만든다면, 어떤 문제를 해결하게 하겠니?'라고 물어보세요."
        },
        noon: {
            title: "행동하는 지성: 바울의 에이전틱 리더십",
            content: "사도 바울은 2천 년 전 최초의 '에이전틱 리더'였습니다. 예루살렘 공회의 지시를 기다리지 않고, 성령의 인도 아래 스스로 판단하여 소아시아와 유럽을 넘나들며 교회를 세웠습니다. 그는 천막을 만들어 생계를 해결하고(텐트메이킹), 각 도시의 문화와 언어에 맞게 전략을 조정하며(컨텍스트 인식), 디모데와 디도 같은 차세대 리더를 양성했습니다(멀티 에이전트 시스템). AI 에이전트가 갖추려는 자율성, 도구 활용, 맥락 이해, 협업 능력은 사실 바울이 이미 삶으로 보여준 리더십의 본질입니다. 우리 아이들이 배워야 할 것은 코딩 문법이 아니라, 이 '에이전틱 정신'입니다.",
            icon: Compass,
            color: "blue"
        },
        evening: {
            title: "주도적 삶의 설계자: 하나님의 에이전트로 세워지는 아이들",
            content: "에이전트(Agent)의 어원은 라틴어 'agere', 즉 '행동하다'입니다. 하나님께서는 우리를 수동적 관객이 아닌, 이 세상을 능동적으로 가꾸는 '청지기(Steward)'이자 '대리자(Agent)'로 부르셨습니다. 에덴동산에서 아담에게 맡기신 첫 사명도 '경작하고 지키는' 주도적 행동이었습니다. AI가 스스로 행동하는 시대, 우리 아이들은 더욱 깊은 차원에서 자신의 삶을 설계하고, 이웃을 섬기며, 세상을 선하게 바꾸는 '하나님의 에이전트'로 성장해야 합니다.",
            actionTitle: "오늘 아이의 손을 잡고 주도적 삶을 위해 축복해 주세요",
            actionContent: "\"주님, 이 아이가 남의 지시만 기다리는 수동적인 사람이 아니라, 스스로 생각하고 판단하며 세상을 섬기는 당신의 능동적인 에이전트로 자라나게 하소서. 바울처럼 담대하고, 다니엘처럼 지혜롭게 하소서.\"",
            icon: Heart,
            color: "indigo"
        },
        media: {
            title: "AI 에이전트가 바꾸는 미래 (앤드류 응)",
            url: "https://www.youtube.com/watch?v=KrRD7r7y7NY",
            image: "https://img.youtube.com/vi/KrRD7r7y7NY/sddefault.jpg",
            desc: "스탠포드 AI 석학 앤드류 응이 설명하는 에이전틱 AI의 미래",
            icon: PlayCircle
        }
    },
    {
        id: 19,
        date: "2026.03.17 • Tue",
        title: "[Hot Issue] 젊은 지성을 위한 '아이캔 파운드리(Foundry)' 입문",
        subtitle: "전통을 넘어 AI 친화기업으로: 팔란티어형 파운드리가 만드는 비즈니스 혁명",
        themeChip: "Power Shift",
        morning: {
            title: "팔란티어형 파운드리를 아십니까?",
            content: "최근 실리콘밸리와 스타트업 커뮤니티의 최대 화두는 '팔란티어(Palantir)'식 파운드리 모델입니다. 이는 단순히 데이터를 쌓아두는 것을 넘어, 흩어진 정보를 유기적으로 연결하여 즉각적인 행동(Action)을 이끌어내는 데이터 엔진을 의미합니다. 우리 아이들은 이제 파도를 타는 법이 아니라, 스스로 파도를 조절하는 '파운드리'를 설계할 수 있는 지휘 능력을 배워야 합니다.",
            icon: Cpu,
            color: "orange",
            mission: "Mission: 오늘 아이에게 '데이터'가 어떻게 '의미 있는 행동'으로 바뀔 수 있는지 함께 상상해 보세요."
        },
        noon: {
            title: "전통 기업의 대전환: AI 친화기업이 되는 법",
            content: "이제 과거의 성공 공식은 더 이상 통하지 않습니다. 전통적인 하이테크 기업들조차 AI 친화적인 구조로 체질을 개선하는 것이 유일한 생존 전략이 되었습니다. 이것이 바로 우리가 '아이캔 파운드리'를 주목하는 이유입니다. 복잡한 로직을 AI가 이해할 수 있는 언어로 변환하고 시스템화하는 과정, 그것이 새로운 시대의 사업 기준이자 성공의 열쇠입니다.",
            icon: Target,
            color: "blue"
        },
        evening: {
            title: "속도가 곧 성공: 파워시프트(Power Shift)의 도구를 쥐라",
            content: "패러다임이 바뀌는 시기에는 '도구를 다루는 자'가 세상을 바꿉니다. 파워시프트의 핵심은 변화의 속도입니다. 단순히 AI를 사용하는 것을 넘어, AI가 비즈니스의 심장이 되도록 정렬시키는 'Foundry'의 개념을 이해하고 활용해야 합니다. 우리 아이들이 이 거대한 전환의 흐름 속에서 기술에 종속되지 않고, 기술을 정의하는 리더로 성장하기를 응원합니다.",
            actionTitle: "오늘 아이의 손을 잡고 시대의 흐름을 주도하는 리더가 되길 축복해 주세요",
            actionContent: "\"주님, 이 아이가 변하는 세상 앞에서 두려워하지 않고, 새로운 도구를 능숙하게 다루며 세상을 선하게 바꾸는 지혜로운 리더가 되게 하소서.\"",
            icon: Rocket,
            color: "indigo"
        },
        media: {
            title: "초등학생도 이해하는 팔란티어 파운드리 (빅데이터닥터)",
            url: "https://www.youtube.com/watch?v=A_cApVGVF-w",
            image: "https://img.youtube.com/vi/A_cApVGVF-w/sddefault.jpg",
            desc: "팔란티어의 미래와 기술력을 아이들의 눈높이에서 가장 쉽게 풀어낸 영상",
            icon: PlayCircle
        }
    },
    {
        id: 18,
        date: "2026.03.17 • Tue",
        title: "[Column] 권력의 탐욕에 맞서는 뱀 같은 냉철함",
        subtitle: "기형적 사회와 작금의 전쟁에서 우리 아이들이 가져야 할 지혜",
        themeChip: "Shrewd Wisdom",
        morning: {
            title: "권력과 탐욕의 올무: 기형적 사회의 기원",
            content: "기원전 63년 예루살렘, 로마는 기득권층인 산헤드린 공회에 통제권을 주며 사회를 기형적으로 만들었습니다. 본래의 정통성을 잃고 권력에 기생하여 민초를 착취했던 역사는, 오늘날 이권이 충돌하는 국제적 긴장 상황과도 닮아 있습니다. 우리 아이들은 거대한 힘이 내미는 '사악한 발톱'을 경계하고, 그 이면을 조망하는 힘을 길러야 합니다.",
            icon: Compass,
            color: "orange",
            mission: "Mission: 오늘 아이와 함께 '나의 이익'뿐만 아니라 '정의로운 가치'에 대해 짧게 대화해 보세요."
        },
        noon: {
            title: "뱀 같은 지혜: 사물의 본질을 꿰뚫는 차가운 이성",
            content: "예수님을 함정에 빠뜨리려던 세금 논쟁 당시, 그분은 '데나리온'에 새겨진 탐욕과 위선을 역으로 폭로하셨습니다. 무력이나 감정에 휩쓸리지 않고 본질을 통찰하는 '뱀 같은 냉철함'은 복잡한 현대 사회를 살아갈 우리 아이들이 갖춰야 할 지혜입니다. 사악한 요구에 당당히 대항하는 냉철한 지성은 불의한 올무를 피하게 하는 가장 강력한 무기입니다.",
            icon: Target,
            color: "blue"
        },
        evening: {
            title: "왕 같은 제사장: 전쟁의 참혹함을 이기는 사랑의 연대",
            content: "로마에 의해서 임명된 대제사장들이 자신의 진정한 소명을 잃어버릴 때, 초대교인들은 삶과 사랑으로 진정한 하나님의 대리자임을 증명했습니다. 톨스토이가 『전쟁과 평화』를 통해 전했듯, 진정한 선은 남을 지배하는 데 있지 않고 고통받는 이들에게 사랑을 베푸는 데 있습니다. 우리 아이들이 불의에 타협하지 않고 세상을 섬기는 '왕 같은 제사장'으로 성장하기를 소망합니다.",
            actionTitle: "오늘 아이의 손을 잡고 냉철한 지성와 따스한 사랑을 위해 기도해 주세요",
            actionContent: "\"주님, 이 아이가 세상의 기만과 탐욕을 꿰뚫는 뱀 같은 지혜를 갖게 하소서. 차가운 이성으로 세상을 보되, 가슴에는 그리스도의 뜨거운 사랑을 품어 평화를 만드는 리더가 되게 하소서.\"",
            icon: Heart,
            color: "indigo"
        },
        media: {
            title: "탐욕의 시대를 이기는 지혜 (War and Peace)",
            url: "https://www.youtube.com/watch?v=nVRisv1MX_c",
            image: "https://img.youtube.com/vi/nVRisv1MX_c/sddefault.jpg",
            desc: "톨스토이의 전쟁과 평화, 그리고 작금의 전쟁에 대한 통찰",
            icon: PlayCircle
        }
    },
    {
        id: 17,
        date: "2026.03.16 • Mon",
        title: "[Special] 프로젝트 헤일메리: 아이들을 위한 우주적 사고의 시작",
        subtitle: "미지의 너와 만나 우주를 구하는 법: 스페이스 오리엔티어링과 휴머니티",
        themeChip: "Space Humanity",
        morning: {
            title: "미션: 스페이스 오리엔티어링 (Space Orienteering)",
            content: "영화 속 주인공이 미지의 세계에서 생존을 건 문제를 해결하듯, 우리 아이들도 원인 모를 우주적 난제를 논리적 사고와 과학적 근거로 직접 해결해 나가는 법을 배웁니다. 이것이 아이캔이 지향하는 '스페이스 오리엔티어링'의 핵심입니다. 낯선 환경에서도 당황하지 않고 자신만의 나침반을 찾아가는 힘, 그것이 미래 인재의 첫 번째 조건입니다.",
            icon: Rocket,
            color: "orange",
            mission: "Mission: 오늘 아이의 질문에 정답을 주기보다, 그 질문을 풀어나갈 '나침반(단서)'을 함께 찾아보는 시간을 가져보세요."
        },
        noon: {
            title: "교구와 기술: 라즈베리파이 키트로 구현하는 우주적 사고",
            content: "아이캔이 준비한 전용 앱과 '라즈베리파이 하드웨어 키트'를 통해 아이들은 복잡한 우주 과학 원리를 직접 구현해봅니다. AI 기반의 실감형 테크놀로지는 단순한 지식 습득을 넘어, 광활한 우주 관점에서 문제를 바라보는 통찰력(Cosmic Thinking)을 길러줍니다. 이제 교육은 머리로만 하는 것이 아니라, 도구를 활용해 세상을 직접 움직이는 경험이어야 합니다.",
            icon: Cpu,
            color: "blue"
        },
        evening: {
            title: "고귀한 자기희생: 인류를 살리는 사랑의 원자력",
            content: "자신의 생명보다 친구와 인류의 생존을 선택한 주인공의 희생은, 우리 아이들이 배워야 할 가장 고귀한 인류애입니다. 이는 우리를 위해 친히 이 땅에 오셔서 자기희생으로 사랑을 완성하신 예수님의 십자가 사랑, 그리고 그 사랑을 온몸으로 살아낸 사도 바울의 발자취와 닮아 있습니다. 기술이 발달할수록 우리는 더욱 '사랑의 원동력'을 가진 인간다운 리더로 우리 아이들을 키워내야 합니다.",
            actionTitle: "오늘 아이에게 '함께하는 가치'를 가르쳐주세요",
            actionContent: "\"혼자 가면 빨리 가지만, 함께 가면 멀리 간단다. 너의 탁월한 기술과 지혜가 세상을 살리는 따뜻한 사랑의 도구가 되기를 바란다. 너는 하나님의 자랑스러운 최고의 우주 리더야.\"",
            icon: Heart,
            color: "indigo"
        },
        media: {
    ...
    },
    {
        ...
        themeChip: "Future Paradigm",
        morning: {
            title: "왜 서울의 학부모들은 시골 기숙학교에 열광할까요?",
            content: "어머님, 최근 화산중학교 이야기가 전국적인 화제입니다. 최고의 학군이라는 강남 대치동을 떠나, 전북 완주의 시골 중학교로 아이들을 보내기 위해 초등학교 때부터 전월세를 구하는 기현상이 벌어지고 있죠.\n이유가 무엇일까요? 부모님들이 마침내 깨닫기 시작한 것입니다. '붕어빵 찍어내듯 정답만 주입하는 보습학원식 경쟁 교육으로는 다가올 AI 시대, 우주 시대를 살아갈 수 없다'는 뼈아픈 진실을 말입니다.\n [실제 화산중학교가 증명하고 있는 세 가지 혁명]\n 1. 단 한 명도 포기하지 않는 '6단계 수준별 분반'\n 2. '사교육 제로'의 완전한 독립(기숙사 생활)\n 3. 자발성이 만드는 기적의 경쟁률\nAI가 모든 지식을 대체하는 시대, 우리 아이들에게 필요한 것은 기계가 할 수 없는 '스스로 질문하는 능력'을 갖추어야 생존할 수 있습니다. 화산중의 자율적 교과 운영과 촘촘한 수준별 지도는 바로 이러한 개별화된 '우주적 교육의 패러다임 전환'을 성공적으로 입증한 사례입니다.",
            quote: "너희는 이 세대를 본받지 말고 오직 마음을 새롭게 함으로 변화를 받아... (롬 12:2)",
            icon: Sunrise,
            color: "orange"
        },
        noon: {
            ...
            content: "화산중학교의 가장 큰 경쟁력은 사교육 없이 이루어지는 철저한 '결핍과 독립'의 기숙사 환경입니다. 우주로 나아가는 로켓이 대기권을 돌파하기 위해서는 엄청난 중력 저항을 이겨내는 '인내의 연료'가 필요합니다. 바울이 3년의 아라비아 광야 시간을 견뎠듯 말입니다.\n아이가 학원의 '떠먹여 주기'에 익숙해져 있다면, 그 습관을 버리고 자기주도성을 찾아가는 데는 뼈를 깎는 텐트메이킹(Tentmaking)의 훈련이 동반되어야 합니다. 아이캔어학원 역시 단기적인 성적 향상이 아니라 다가올 우주 시대의 필수 무기인 '최고의 이중언어(Bilingual) 능력자'로 스스로 성장할 수 있는 튼튼한 발사대(Foundation)가 되어줄 것입니다.",
            icon: Rocket,
            color: "blue"
        },
        evening: {
            title: "가장 위대한 우주 비행은 '함께' 비행하는 것입니다",
            content: "전교생이 기숙사에 살며 얻어가는 또 다른 비밀은 '팀워크'입니다. 우주비행사들이 고립된 우주선 안에서 생존하기 위해 가장 필요한 것은 수학 공식이 아니라 바로 타인의 결핍을 채워주는 '공감 능력과 관계의 윤리'입니다.\n아무리 뛰어난 엘리트라도 이기주의에 갇히면 우주를 개척할 수 없습니다. 이것이 바로 우리가 '기독교 교육'을 끝까지 붙들어야 하는 이유입니다. 1등을 위한 들러리를 서는 교실이 아니라, 하나님이 창조하신 단 한 명의 아이도 포기하지 않는 긍휼. 바로 이러한 우주적 스케일의 사랑을 배운 아이들만이 글로벌 커뮤니티에서 진짜 리더로 쓰임 받습니다.",
            actionTitle: "오늘의 기도: 함께 비행하는 지혜",
            actionContent: "잠든 아이의 손을 잡고 이렇게 기도해 주십시오.\n\"주님, 이 아이가 남과 비교하는 좁은 세상을 넘어 넒은 우주를 품는 지혜를 허락하소서. 차가운 기술의 시대 속에서도 그리스도의 사랑으로 세상을 품는 리더가 되게 하소서.\"",
            icon: Heart,
            color: "indigo"
        },
        media: {
            title: "전국 방방곡곡에서 학부모들이 산골 중학교로 몰려드는 이유는?",
            url: "https://www.youtube.com/watch?v=FCswPOXVxlU",
            image: "https://img.youtube.com/vi/FCswPOXVxlU/sddefault.jpg",
            desc: "화산중학교 생생한 인터뷰",
            icon: PlayCircle
        }
    },
