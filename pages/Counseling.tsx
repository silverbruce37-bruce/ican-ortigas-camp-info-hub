...
const JOURNAL_ENTRIES = [
    {
        id: 21,
        date: "2026.04.14 • Mon",
        title: "[Episode] 철학이 곧 경쟁력: AI 시대, 아이에게 '사고의 운영체제'를 심어주세요",
        subtitle: "질문 설계력 · 판단 설계력 · 연결 설계력 — 기계가 대체할 수 없는 인간 고유의 3대 역량",
        themeChip: "Thinking OS",
        morning: {
            title: "실리콘밸리가 철학 전공자를 찾는 이유",
            content: "어머님, 놀라운 소식을 전합니다. 하버드, MIT, 스탠포드 등 세계 최고 대학들과 실리콘밸리 기업들이 지금 가장 주목하는 인재는 코딩 전문가가 아니라 '철학 전공자'입니다. 왜일까요? AI가 코드를 스스로 작성하고, 데이터를 스스로 분석하는 시대가 되었기 때문입니다. 기계가 '답'을 주는 시대에, 인간만이 할 수 있는 일은 '올바른 질문을 설계하는 것'입니다. 이것이 바로 첫 번째 핵심 역량인 <b>질문 설계력</b>입니다. '행복이란 무엇인가'라는 모호한 질문을 '어떤 조건에서 인간은 삶을 좋다고 판단하는가'로 정교하게 다듬는 능력, 개념을 분해하고 비판적으로 검증하는 능력 — 이것은 코딩 수업이 아니라 깊은 사고 훈련에서만 나옵니다. 우리 아이들에게 필요한 것은 정답을 외우는 머리가 아니라, 질문을 빚어내는 영혼입니다.",
            icon: Compass,
            color: "orange",
            mission: "Mission: 오늘 아이에게 평소 당연하게 여기던 것 하나를 골라 '왜 그럴까?'라는 질문을 5단계로 깊이 파고들어 보는 '질문 사다리' 게임을 해보세요."
        },
        noon: {
            title: "솔로몬의 판단 설계력: 논리를 넘어 윤리로",
            content: "두 번째 핵심 역량은 <b>판단 설계력</b>입니다. AI가 열 가지 선택지를 내놓을 때, '무엇을 선택해야 하는가'를 결정하는 것은 결국 인간의 몫입니다. 이것은 단순한 논리가 아니라 윤리적 추론의 영역입니다. 성경에서 가장 위대한 판단 설계자는 솔로몬이었습니다. 두 어머니가 한 아이를 두고 다투었을 때, 그는 '아이를 반으로 나누라'는 극단적 시나리오를 설계함으로써 진짜 어머니의 사랑을 드러냈습니다. 솔로몬은 '논리적으로 가능한 것(Can)'을 넘어 '마땅히 해야 할 것(Should)'을 선택한 것입니다. AI 시대의 트롤리 딜레마, 자율주행차의 윤리적 선택, 의료 AI의 판단 기준 — 이 모든 것을 설계하는 사람은 코더가 아니라 '옳고 그름을 분별하는 자'입니다. 모호한 상황에서도 사고를 멈추지 않고 열 단계 앞을 내다보는 인내, 그것이 바울이 고린도전서에서 말한 '장성한 자의 분별력'입니다.",
            icon: Target,
            color: "blue"
        },
        evening: {
            title: "바울의 연결 설계력: 흩어진 세계를 하나로 잇는 사랑",
            content: "세 번째이자 가장 결정적인 역량은 <b>연결 설계력</b>입니다. 질문으로 통찰을 얻고 판단으로 방향을 정했다면, 이제 그것을 융합하여 새로운 창조물로 만들어야 합니다. 사도 바울이야말로 역사상 가장 위대한 연결 설계자였습니다. 그는 유대교 신학, 헬라 철학, 로마 법률이라는 전혀 다른 세 세계의 언어를 하나로 번역하고 통합하여 기독교라는 보편적 세계관을 설계했습니다. 아테네 아레오바고에서 '알지 못하는 신'의 제단을 복음의 출발점으로 연결한 것(사도행전 17장)이 바로 학제 간 번역의 원형입니다. AI가 쏟아내는 파편화된 지식을 연결하여 명료한 하나의 이야기로 전달하는 능력, 심리학과 철학과 기술을 넘나들며 새로운 의미를 창조하는 능력 — 이것이 기계가 결코 흉내 낼 수 없는 인간의 최종 무기입니다.",
            actionTitle: "오늘 아이의 손을 잡고 '사고의 운영체제'를 위해 기도해 주세요",
            actionContent: "\"주님, 이 아이에게 솔로몬의 분별력과 바울의 연결하는 지혜를 허락하소서. 기계가 답을 주는 시대에 올바른 질문을 던지는 용기를, 쉬운 길 대신 옳은 길을 택하는 판단력을, 그리고 흩어진 세상을 사랑으로 잇는 창조의 능력을 심어 주소서. 단기적 기술이 아닌 변치 않는 지혜의 뿌리 위에 이 아이의 미래를 세워 주소서. 아멘.\"",
            icon: Heart,
            color: "indigo"
        },
        media: {
            title: "철학이 AI 시대 최고의 경쟁력인 이유 (마이클 샌델)",
            url: "https://www.youtube.com/watch?v=AUhBpoFwMJ0",
            image: "https://img.youtube.com/vi/AUhBpoFwMJ0/sddefault.jpg",
            desc: "하버드 철학 교수 마이클 샌델이 말하는 기술 시대의 인문학적 사고의 힘",
            icon: PlayCircle
        }
    },
    {
